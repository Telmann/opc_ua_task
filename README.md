...
#### 1. На подключение к серверу при создании таблицы и получение тегов уходит +- 3 секунды. 
#### 2. На создание таблицы и Ввод тегов уходит +- 30 секунд.
#### 3. На обработку данных (добавление их в массив) при последующем обновлении уходит +- 30 сек.
